...
function startPrintMode(mode) {
  ...
  printCleanupTimer = setTimeout(cleanupPrintMode, 120000);
}
...
function buildStandalonePrintHtml(mode, contentHtml) {
  ...
  const css = isTicket ? `
    ...
    /* v01.6 : rendu iPad calé sur le ticket Mac : titre encadré + corps légèrement agrandi */
    .ticket-order {
      text-align:center;
      font-size:14pt;
      font-weight:900;
...
function ensureDirectPrintStyle(mode) {
  ...
  if (mode === "print-ticket") {
    style.textContent = `
@media print {
  /* v01.6 : contre-marges AirPrint iPad/Epson.
  ...
  body.print-ticket #printArea .ticket-menu-line > strong em { justify-self:end !important; font-size:11.5pt !important; font-style:normal !important; font-weight:900 !important; white-space:nowrap !important; }
  ...
  body.print-ticket #printArea .ticket-checks { display:inline-block !important; white-space:nowrap !important; font-family:Arial, Helvetica, sans-serif !important; font-size:25pt !important; line-height:1 !important; letter-spacing:.55mm !important; min-width:7mm !important; text-align:right !important; }
  body.print-ticket #printArea .ticket-checks.empty { min-width:7mm !important; }
  body.print-ticket #printArea .ticket-box { display:inline !important; border:0 !important; width:auto !important; height:auto !important; font-size:25pt !important; line-height:1 !important; font-weight:1000 !important; }
...
function printCurrentContent(mode) {
  // v01.6 : retour à l'impression directe de la page principale.
...
/* v01.6 : pas de nettoyage sur afterprint/focus pendant le second rendu iPad/Chrome. */
